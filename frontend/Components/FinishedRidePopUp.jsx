...
const FinishedRidePopUp = ({ setFinished }) => {
  ...
  return (
    <div className='w-[93vw]'>
      ...
      <h3 className="text-3xl font-semibold text-red mx-2">Finish this Ride </h3>
      ...
      <div className="">
        ...
        <button className="w-full text-xl text-white font-bold rounded-xl p-2 mt-5 bg-green-600">
          <Link to="/captains-home">Complete Ride</Link>
        </button>
        <button onClick={() => {
          setFinished(false)
...
export default FinishedRidePopUp
